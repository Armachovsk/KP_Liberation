...
private _houses = [_pos, _radius] call SPEC_fnc_common_getHouses;
if !(_houses isEqualTo []) then {
    private _house = selectRandom _houses;
    [_group, _house] call SPEC_fnc_common_addWPLoop;
    _houses = _houses - [_house];
};

for "_i" from 1 to 4 do {
    private _wp_pos = [_pos, _radius] call SPEC_fnc_common_randomizePos;
