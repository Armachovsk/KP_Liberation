...
KPLIB_b_potato01 = "rhsusf_CH53e_USMC_D_cargo";                                          // This is Potato 01, a multipurpose mobile respawn as a helicopter.
KPLIB_b_crewUnit = "rhsusf_usmc_marpat_d_combatcrewman";                    // This defines the crew for vehicles.
KPLIB_b_heliPilotUnit = "rhsusf_usmc_marpat_d_helipilot";                          // This defines the pilot for helicopters.
KPLIB_b_addHeli = "RHS_UH1Y_d";                          // These are the additional helicopters which spawn on the Freedom or at Chimera base.
...
*/
KPLIB_b_infantry = [
    ["rhsusf_usmc_marpat_d_rifleman_light",15,0,0],                               // Rifleman (Light)
    ["rhsusf_usmc_marpat_d_rifleman",20,0,0],                                // Rifleman
    ["rhsusf_usmc_marpat_d_rifleman_law",30,0,0],                              // Rifleman (AT)
    ["rhsusf_usmc_marpat_d_grenadier",25,0,0],                               // Grenadier
    ["rhsusf_usmc_marpat_d_autorifleman",25,0,0],                            // Autorifleman
    ["rhsusf_usmc_marpat_d_machinegunner",35,0,0],                           // Heavygunner
    ["rhsusf_usmc_marpat_d_sniper",30,0,0],                                // Marksman
    ["rhsusf_usmc_marpat_d_javelin",50,10,0],                                // AT Specialist
    ["rhsusf_usmc_marpat_d_stinger",50,10,0],                                     // AA Specialist
    ["rhsusf_navy_marpat_d_medic",30,0,0],                                   // Combat Life Saver
    ["rhsusf_usmc_marpat_d_engineer",30,0,0],                                // Engineer
    ["rhsusf_usmc_marpat_d_explosives",30,0,0],                              // Explosives Specialist
    ...
    ["rhsusf_usmc_recon_marpat_d_marksman_fast",30,0,0],                     // Recon Marksman
    ["rhsusf_usmc_recon_marpat_d_sniper_M107",70,5,0],                  // Recon Sniper (M107)
    ["rhsusf_usmc_marpat_d_sniper_m110",70,5,0],                                  // Sniper
    ["rhsusf_usmc_marpat_d_sniper_m107",70,5,0],                             // Sniper (M107)
    ["rhsusf_usmc_marpat_d_sniper",70,5,0],                           // Sniper (M24 SWS)
    ["rhsusf_usmc_lar_marpat_d_crewman",10,0,0],                           // Crewman
